...
#ifdef VENDOR_EDIT
# huwei5@oppo.com 2019/11/07. Add macro to enable/disable
ifeq ($(OPPO_ENABLE_IRIS),true)
CFLAGS_KERNEL +=   -DENABLE_IRIS
CFLAGS_MODULE +=   -DENABLE_IRIS
CC_FLAGS_USING += -DENABLE_IRIS
...
#ifdef VENDOR_EDIT//BIn.Li@BSP.Kernel.Drive,add 2019/10/25  for close subsys dump
ifeq ($(SUBSYS_DUMP_CLOSE_CONFIG),1)
KBUILD_CFLAGS += -DCONFIG_SUBSYS_DUMP_CLOSE_CONFIG
endif
#endif /* VENDOR_EDIT */
#endif /*VENDOR_EDIT*/
...
#kasan 64KB stack ,memory high loading
